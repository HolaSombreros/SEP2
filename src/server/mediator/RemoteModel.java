...
public interface RemoteModel extends RemoteSubject<User, Appointment>
{
    ...
    void addAppointment(Date date, TimeInterval timeInterval, Appointment.Type type, User patient,User nurse) throws RemoteException;
    AppointmentTimeList getAppointmentsByUser(User patient) throws RemoteException;
