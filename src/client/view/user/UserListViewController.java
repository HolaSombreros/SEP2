...
import client.viewmodel.user.UserListViewModelInterface;
import client.viewmodel.user.UserTableViewModel;
...
public class UserListViewController extends ViewController
{
    ...
    @FXML
    private TableView<UserTableViewModel> userTable;
    @FXML
    private TableColumn<UserTableViewModel, String> cprColumn;
    @FXML
    private TableColumn<UserTableViewModel, String> nameColumn;
    @FXML
    private TableColumn<UserTableViewModel, String> phoneColumn;
    @FXML
    private TableColumn<UserTableViewModel, String> emailColumn;
    @FXML
    private TableColumn<UserTableViewModel, String> vaccineColumn;
    @FXML
    ...
    @FXML
    private void seeNurses() {
        viewModel.seeNurses();
    }

    @FXML
    private void seeAdmins() {
        viewModel.seeAdmins();
    }
}
