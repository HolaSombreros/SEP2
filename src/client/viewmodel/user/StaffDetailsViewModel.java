...
public class StaffDetailsViewModel implements StaffDetailsViewModelInterface {
    ...
    @Override
    public void disableDays(DatePicker week) {
    ...
    @Override
    public BooleanProperty getShift0() {
        return shift0;
    }

    @Override
    public BooleanProperty getShift1() {
        return shift1;
    }

    @Override
    public BooleanProperty getShift2() {
        return shift2;
    }
    ...
    @Override
    public BooleanProperty getDisplayProperty() {
        return display;
    }
